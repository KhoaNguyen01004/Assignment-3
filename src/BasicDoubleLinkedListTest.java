...
public class BasicDoubleLinkedListTest {
	...
	public final Car a = new Car("Ford", "F150", 2005);
	public final Car b = new Car("Jeep", "Renegade", 2005);
	public final Car c = new Car("Honda", "Civic", 2005);
	public final Car d = new Car("Subaru", "Outback", 2005);
	public final Car e = new Car("Chevrolet", "Silverado", 2005);
	public final Car f = new Car("Chrysler", "PTCruiser", 2005);

	ArrayList<Car> fill = new ArrayList<>();
